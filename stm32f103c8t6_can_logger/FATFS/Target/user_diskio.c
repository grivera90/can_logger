...
/* Private define ------------------------------------------------------------*/
#define CS_INIT()
#define	CS_H()		HAL_GPIO_WritePin(SPI1_CS_GPIO_Port, SPI1_CS_Pin, GPIO_PIN_SET)	/* Set MMC CS "high" */
#define CS_L()		HAL_GPIO_WritePin(SPI1_CS_GPIO_Port, SPI1_CS_Pin, GPIO_PIN_RESET)	/* Set MMC CS "low" */
